...
func main() {
	...
	SaveImage("Edge Filtered Images/"+filename+"_edge_detected.jpg", edgeImg)

	//Ends The Timer
	endTime := time.Now()

	//Prints The Time with goroutines
	fmt.Printf("Duration avec goroutines: %s\n", endTime.Sub(startTime))
}