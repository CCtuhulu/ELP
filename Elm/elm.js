...
{
	if (region.R.C === region._.C)
	{
		return 'on line ' + region.R.C;
	}
	return 'on lines ' + region.R.C + ' through ' + region._.C;
}
...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.aR, request.aB, true);
		} catch (e) {
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {ac: fragment, af: host, al: path, an: port_, aq: protocol, ar: query};
	});
...
var $author$project$Main$GotWord = function (a) {
	return {$: 0, a: a};
};
var $author$project$Main$Loading = 1;
var $author$project$Main$Model = function (def_list) {
	return function (word_list) {
		return function (selectedWord) {
			return function (state) {
				return function (guessed) {
					return function (load) {
						return function (newLoad) {
							return function (definition_nb) {
								return function (correct) {
									return function (elapsedTime) {
										return {I: correct, L: def_list, B: definition_nb, v: elapsedTime, J: guessed, r: load, K: newLoad, x: selectedWord, D: state, U: word_list};
									};
								};
							};
						};
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{aH: false, aJ: r.aJ, ab: r.ab, ad: r.ad, aR: r.aR, a0: r.a0, aA: r.aA, aB: r.aB}));
};
var $elm$http$Http$get = function (r) {
	return $elm$http$Http$request(
		{aJ: $elm$http$Http$emptyBody, ab: r.ab, ad: _List_Nil, aR: 'GET', a0: $elm$core$Maybe$Nothing, aA: $elm$core$Maybe$Nothing, aB: r.aB});
};
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		$author$project$Main$Model(_List_Nil)(_List_Nil)('')(1)('')('')('')(1)(false)(0),
		$elm$http$Http$get(
			{
				ab: $elm$http$Http$expectString($author$project$Main$GotWord),
				aB: 'http://localhost:8000/resources/words.txt'
			}));
};
...
var $elm$time$Time$State = F2(
	function (taggers, processes) {
		return {ap: processes, az: taggers};
	});
...
var $author$project$Main$Random_nb = function (a) {
	return {$: 1, a: a};
};
...
var $author$project$Main$WordDefinition = F2(
	function (word, meanings) {
		return {ah: meanings, a4: word};
	});
var $elm$json$Json$Decode$field = _Json_decodeField;
var $author$project$Main$Meaning = F2(
	function (partOfSpeech, definitions) {
		return {Z: definitions, ak: partOfSpeech};
	});
var $author$project$Main$Definitions = function (definition) {
	return {Y: definition};
};
var $elm$json$Json$Decode$string = _Json_decodeString;
var $author$project$Main$definitionsDecoder = A2(
	$elm$json$Json$Decode$map,
	$author$project$Main$Definitions,
	A2($elm$json$Json$Decode$field, 'definition', $elm$json$Json$Decode$string));
var $author$project$Main$meaningsDecoder = A3(
	...
	A2(
		...
		'definitions',
		$elm$json$Json$Decode$list($author$project$Main$definitionsDecoder)));
var $author$project$Main$wordDecoder = A3(
	...
	A2(
		$elm$json$Json$Decode$field,
		'meanings',
		$elm$json$Json$Decode$list($author$project$Main$meaningsDecoder)));
var $author$project$Main$recupereJson = $elm$json$Json$Decode$list($author$project$Main$wordDecoder);
		...
		switch (msg.$) {
				...
				if (!msg.a.$) {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								U: A2($elm$core$String$split, ' ', text)
							}),
						A2(
							$elm$random$Random$generate,
							$author$project$Main$Random_nb,
							A2($elm$random$Random$int, 0, 999)));
				} else {
					return _Utils_Tuple2(
						_Utils_update(
							model,
			...
			case 1:
				...
				var mot = A2(
					...
					' ',
					$elm$core$List$head(
						A2($elm$core$List$drop, nb, model.U)));
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{x: mot}),
					$elm$http$Http$get(
						{
							ab: A2($elm$http$Http$expectJson, $author$project$Main$GotDefinition, $author$project$Main$recupereJson),
							aB: 'https://api.dictionaryapi.dev/api/v2/entries/en/' + mot
						}));
			case 2:
				var def = msg.a;
				if (!def.$) {
			...
			case 4:
				...
				return _Utils_eq(
					...
					$elm$core$String$toLower(model.x)) ? _Utils_Tuple2(
					_Utils_update(
						model,
						{
							I: true,
							r: message,
							K: 'Congratulations ! You guessed the word in ' + ($elm$core$String$fromInt(model.v) + ' seconds!!')
						}),
			...
			case 6:
				...
				var randomCmd = A2(
					...
					$author$project$Main$Random_nb,
					A2($elm$random$Random$int, 0, 999));
				return _Utils_Tuple2(updatedModel, randomCmd);
			default:
				var newTime = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text(definition.Y)
					]))
			]));
};
var $author$project$Main$viewMeaning = F2(
				...
				[
					...
					_List_fromArray(
						[
							...
							A2($elm$html$Html$Attributes$style, 'list-style', 'arabic')
						]),
					A2(
						$elm$core$List$map,
						$author$project$Main$viewDefinition,
						A2($elm$core$List$take, model.B, meaning.Z)))
				]));
	});
	...
	switch (_v0) {
		case 0:
			return A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Unable to load your page.')
					]));
		case 1:
			...
			return A2(
				...
				_List_fromArray(
					[
						...
						A2($elm$html$Html$Attributes$style, 'gap', '1vh'),
						A2($elm$html$Html$Attributes$style, 'background-color', 'lightcoral'),
						A2($elm$html$Html$Attributes$style, 'width', 'fit-content'),
						A2($elm$html$Html$Attributes$style, 'min-width', '30vw'),
						A2($elm$html$Html$Attributes$style, 'max-width', '75vw'),
						A2($elm$html$Html$Attributes$style, 'margin', 'auto'),
						A2($elm$html$Html$Attributes$style, 'margin-top', '5vh'),
						A2($elm$html$Html$Attributes$style, 'margin-bottom', '5vh'),
						A2($elm$html$Html$Attributes$style, 'box-shadow', '4px 4px 2px black'),
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Try to guess the word below based on its definition')
							])),
						A2(
						$elm$html$Html$div,
						_List_fromArray(
							[
								...
								A2($elm$html$Html$Attributes$style, 'font-family', 'auto')
							]),
						_List_fromArray(
							[
								A2(
								...
								A2(
									...
									function (wordDef) {
										return A2(
											$elm$core$List$map,
											function (meaning) {
												return A2($author$project$Main$viewMeaning, meaning, model);
											},
											wordDef.ah);
									},
									model.L))
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Events$onClick($author$project$Main$AddDef)
									]),
								_List_fromArray(
									[
										$elm$html$Html$text('Add more definitions')
									]))
							])),
						A2(
						$elm$html$Html$div,
						...
						_List_fromArray(
							[
								...
								$elm$core$String$isEmpty(model.r) ? A2(
								$elm$html$Html$div,
								_List_fromArray(
									[
										A2($elm$html$Html$Attributes$style, 'font-size', 'large')
								...
								_List_fromArray(
									[
										$elm$html$Html$text('Input Your guess!')
									])) : (_Utils_eq(
								$elm$core$String$toLower(model.r),
								$elm$core$String$toLower(model.x)) ? A2(
								$elm$html$Html$div,
								_List_fromArray(
									[
										A2($elm$html$Html$Attributes$style, 'font-size', 'large')
								...
								_List_fromArray(
									[
										$elm$html$Html$text('You didn\'t guess the word, try again or skip to the next one')
									])))
							])),
						A2(
						$elm$html$Html$div,
							...
							[
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$elm$html$Html$text('Get a new word')
											]))
									]))
							]))
					]));
...
var $author$project$Main$main = $elm$browser$Browser$element(
	{aQ: $author$project$Main$init, a$: $author$project$Main$subscriptions, a2: $author$project$Main$update, a3: $author$project$Main$view});
